...
{
    /// <summary>
    /// Helper class for resolving dependencies with injection to existing object
    /// It wors a little bit like service locator for WindsorContainer O:-)
    /// </summary>
    internal static class DependencyInjectionWebFormsHelper
	{
		...
		/// <summary>
		/// Retrns a collection of injectable properties for the control
		/// </summary>
